...
# Thread-safe JSONL writer that buffers+flushes chapter records incrementally.
@dataclass
...
# Yield parsed JSONL records sorted by chapter number.
...
# Return the set of chapter ids already successfully scraped.
...
# Collapse successful JSONL records into a single ordered JSON file.
