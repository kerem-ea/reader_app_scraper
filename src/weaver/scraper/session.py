...
# Poll the page until the Cloudflare challenge clears; return final HTML.
...
# Visit a chapter in Camoufox and harvest its cookies + user agent for HTTP mode.
...
# Retry bootstrap_session a few times before giving up.
